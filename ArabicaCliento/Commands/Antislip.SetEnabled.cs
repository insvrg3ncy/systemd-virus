...
{
    public string Command => "systemd.anti_slip.set_enabled";
    public string Description => "Включить или выключить антискольжение";
    public string Help => "systemd.anti_slip.set_enabled <bool>";
